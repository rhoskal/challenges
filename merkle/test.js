...
describe('merkle', function() {
  ...
  describe('has a root property correctly set when', function() {
    it('has a power of two elements', function() {
      var myMerkle = new merkle(['This', 'is', 'a', 'test'], simpleHasher);
    ...
    it('has a power of two elements with dupes', function() {
      var myMerkle = new merkle(['This', 'is', 'cool', 'cool'], simpleHasher);
      assert.equal(myMerkle.root, 678075951, 'hashes match');
    });

    it('has a an odd number of elements', function() {
      var myMerkle = new merkle(['This', 'is', 'cool'], simpleHasher);
      assert.equal(myMerkle.root, 678075951, 'hashes match');
    });
    ...
    it('has a large number of elements', function() {
      ...
      var myMerkle = new merkle(arr, simpleHasher);
  ...
  describe('can verify an element is in a tree when', function() {
    it('has a power of two elements', function() {
      ...
      assert(myMerkle.verify('is', myMerkle.root, obj, simpleHasher));
    });

    it('has a power of two elements with dupes', function() {
      var myMerkle = new merkle(['This', 'is', 'cool', 'cool'], simpleHasher);
      var obj = myMerkle.getVerification('cool')
      assert(myMerkle.verify('cool', myMerkle.root, obj, simpleHasher))
    });
  ...
  it('works just like bitcoin!', function() {
    ...
    var myMerkle = new merkle(values, doublesha256);
    ...
    assert(myMerkle.verify(lookFor, myMerkle.root, obj, doublesha256));
  });
});
